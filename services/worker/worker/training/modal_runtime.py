...
def _modal_training_timeout_seconds() -> int:
    return _positive_int_env(
        "MODEL_EXPRESS_MODAL_TRAINING_TIMEOUT_SECONDS",
        DEFAULT_MODAL_TRAINING_TIMEOUT_SECONDS,
    )
