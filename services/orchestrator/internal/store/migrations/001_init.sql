...
CREATE TABLE IF NOT EXISTS worker_requirements (
  ...
  dataset_cache_key text NOT NULL DEFAULT '',
  dataset_materialization_status text NOT NULL DEFAULT '',
  cold_cache_policy text NOT NULL DEFAULT '',
  max_concurrent_jobs integer NOT NULL DEFAULT 0,
  max_cold_dataset_materializations integer NOT NULL DEFAULT 0,
