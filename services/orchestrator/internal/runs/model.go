...
type TrainingRunSummary struct {
	...
	DatasetMaterialization map[string]any               `json:"dataset_materialization,omitempty"`
	StageTelemetry         map[string]any               `json:"stage_telemetry,omitempty"`
	ExecutionReferences    *ExecutionArtifactReferences `json:"execution_references,omitempty"`
	CreatedAt              time.Time                    `json:"created_at"`
	UpdatedAt              time.Time                    `json:"updated_at"`
}
...
type TrainingRunSummaryUpdate struct {
	...
	DatasetMaterialization map[string]any               `json:"dataset_materialization"`
	StageTelemetry         map[string]any               `json:"stage_telemetry"`
	ExecutionReferences    *ExecutionArtifactReferences `json:"execution_references,omitempty"`
}

// ExecutionArtifactReferences is deliberately small. It gives dashboard and
